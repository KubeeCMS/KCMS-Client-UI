...
class BBP_Forums_Activity extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'placeholder' => '1px',
				'default'     => '1px',
				'selector'    => '{{WRAPPER}} .diy-forums-activity',
				'separator'   => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .diy-forums-activity' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .diy-forums-activity' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .diy-fa__forum-title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .diy-fa__forum-title',
			)
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .diy-fa__forum-title' => 'margin-bottom: {{SIZE}}px;',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .diy-fa__topic-title h2' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'label'    => __( 'Typography', 'buddyboss-theme' ),
				'selector' => '{{WRAPPER}} .diy-fa__topic-title h2',
			)
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .diy-fa__topic-title h2' => 'margin-bottom: {{SIZE}}px;',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .diy-fa__meta span' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'label'    => __( 'Typography', 'buddyboss-theme' ),
				'selector' => '{{WRAPPER}} .diy-fa__meta span',
			)
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .diy-fa__meta' => 'margin-bottom: {{SIZE}}px;',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .diy-fa__excerpt' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'label'    => __( 'Typography', 'buddyboss-theme' ),
				'selector' => '{{WRAPPER}} .diy-fa__excerpt',
			)
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .diy-fa__excerpt' => 'margin-bottom: {{SIZE}}px;',
				],
			]
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .diy-fa__link a' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .diy-fa__link a' => 'background-color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .diy-fa__link a' => 'border-color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .diy-fa__link a:hover' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .diy-fa__link a:hover' => 'background-color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .diy-fa__link a:hover' => 'border-color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'label'    => __( 'Typography', 'buddyboss-theme' ),
				'selector' => '{{WRAPPER}} .diy-fa__link a',
			)
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .diy-fa__link a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .diy-forums-activity-btn a.diy-forums-activity-btn__link' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .diy-forums-activity-btn a.diy-forums-activity-btn__link' => 'background-color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .diy-forums-activity-btn a.diy-forums-activity-btn__link' => 'border-color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .diy-forums-activity-btn a.diy-forums-activity-btn__link:hover' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .diy-forums-activity-btn a.diy-forums-activity-btn__link:hover' => 'background-color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .diy-forums-activity-btn a.diy-forums-activity-btn__link:hover' => 'border-color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'label'    => __( 'Typography', 'buddyboss-theme' ),
				'selector' => '{{WRAPPER}} .diy-forums-activity-btn a.diy-forums-activity-btn__link',
			)
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .diy-forums-activity-btn a.diy-forums-activity-btn__link' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .diy-forums-activity-btn' => 'top: -{{SIZE}}px;',
				],
			]
		);
	...
	protected function render() {
		...
		<div class="diy-forums-activity-wrapper <?php echo ( $settings['switch_my_discussions'] ) ? 'diy-forums-activity-wrapper--ismy' : ''; ?>">

			<?php if ( $settings['switch_my_discussions'] && is_user_logged_in() ) { ?>
				<div class="diy-forums-activity-btn">
					<a class="diy-forums-activity-btn__link" href="<?php echo $my_discussions_link; ?>"><?php echo $settings['my_discussions_button_text']; ?><i class="bb-icon-angle-right"></i></a>
				</div>
			<?php } ?>

			<div class="diy-forums-activity">
			...
			if ( is_user_logged_in() ) {
				...
				if ( $query ) {
					...
					while ( bbp_topics() ) :
						...
						?>
						<div class="diy-fa diy-fa--item">

							<?php if ($settings['switch_forum_title']) : ?>
								<div class="diy-fa__forum-title"><?php echo $forum_title; ?></div>
							<?php endif; ?>
							<div class="diy-fa__topic-title"><h2><?php echo $topic_title; ?></h2></div>
							<?php if ($settings['switch_meta']) : ?>
								<div class="diy-fa__meta">
									<span class="diy-fa__meta-count"><?php echo $topic_reply_count; ?> <?php _e( 'repl' . ($topic_reply_count != 1 ? 'ies' : 'y') . ' ', 'buddyboss-theme' ); ?></span>
									<span class="bs-separator">·</span>
									<span class="diy-fa__meta-who"><?php echo $get_last_reply_author_name; ?> <?php _e( 'replied', 'buddyboss-theme' ); ?> </span>
									<span class="diy-fa__meta-when"><?php echo $get_last_reply_since; ?></span>
								</div>
							<?php endif; ?>
							<?php if ($settings['switch_excerpt']) : ?>
								<div class="diy-fa__excerpt <?php echo (!empty($get_last_reply_excerpt)) ? 'is-excerpt' : 'is-empty'; ?> <?php echo ( $settings['switch_excerpt_icon'] ) ? 'is-link' : 'no-link'; ?>">
									<?php
							...
							<?php if ($settings['switch_link']) : ?>
								<div class="diy-fa__link"><a href="<?php echo $get_discussion_link; ?>"><?php echo $settings['button_text']; ?></a></div>
							<?php endif; ?>
					...
					<div class="diy-no-data diy-no-data--fa-activity">
						<img class="diy-no-data__image" src="<?php echo get_template_directory_uri(); ?>/assets/images/svg/dfy-no-data-icon03.svg" alt="Forums Activity" />
						<div class="diy-no-data__msg"><?php _e( 'You don\'t have any discussions yet.', 'buddyboss-theme' ); ?></div>
						<a href="<?php echo home_url(bbp_get_root_slug()); ?>" class="diy-no-data__link"><?php _e( 'Explore Forums', 'buddyboss-theme' ); ?></a>
					</div>
