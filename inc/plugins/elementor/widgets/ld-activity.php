...
class Ld_Activity extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .diy-la-block' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .diy-ldactivity .thumbnail-container img' => 'border-radius: {{TOP}}{{UNIT}} 0 0 {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .diy-ldactivity .thumbnail-container' => 'border-radius: {{TOP}}{{UNIT}} 0 0 {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .diy-la-composer.diy-la--isslick:after' => 'border-radius: 0 {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} 0;',
					'{{WRAPPER}} .diy-ldactivity .diy-la__media:after' => 'border-radius: {{TOP}}{{UNIT}} 0 0 {{LEFT}}{{UNIT}};',
					'@media( max-width: 544px ) { {{WRAPPER}} .diy-ldactivity .thumbnail-container img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} 0 0 };',
					'@media( max-width: 544px ) { {{WRAPPER}} .diy-ldactivity .thumbnail-container' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} 0 0 };',
					'@media( max-width: 544px ) { {{WRAPPER}} .diy-ldactivity .diy-la__media:after' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} 0 0 };',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .diy-ldactivity .diy-la__body' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'types' => [ 'classic', 'gradient' ],
				'selector' => '{{WRAPPER}} .diy-ldactivity .diy-la__media:after',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .diy-la__parent' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .diy-la__parent',
			)
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .diy-la__parent' => 'margin-bottom: {{SIZE}}px;',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .diy-la__title h2' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'label'    => __( 'Typography', 'buddyboss-theme' ),
				'selector' => '{{WRAPPER}} .diy-la__title h2',
			)
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .diy-la__title h2' => 'margin-bottom: {{SIZE}}px;',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .diy-la__excerpt' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'label'    => __( 'Typography', 'buddyboss-theme' ),
				'selector' => '{{WRAPPER}} .diy-la__excerpt',
			)
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .diy-la__excerpt' => 'margin-bottom: {{SIZE}}px;',
				],
			]
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .diy-la__link a' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .diy-la__link a' => 'background-color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .diy-la__link a' => 'border-color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .diy-la__link a:hover' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .diy-la__link a:hover' => 'background-color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .diy-la__link a:hover' => 'border-color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'label'    => __( 'Typography', 'buddyboss-theme' ),
				'selector' => '{{WRAPPER}} .diy-la__link a',
			)
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .diy-la__link a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .diy-la .slick-arrow.bb-slide-prev' => 'left: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .diy-la .slick-arrow.bb-slide-next' => 'right: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .diy-la .slick-arrow' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .diy-la .slick-arrow i' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .diy-la .slick-arrow' => 'background-color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .diy-la .slick-arrow:hover i' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .diy-la .slick-arrow:hover' => 'background-color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .diy-la .slick-arrow',
			)
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .diy-ldactivity ul.slick-dots li.slick-active button' => 'background-color: {{VALUE}};',
				],
				'condition' => [
					'switch_dots' => 'yes',
					'no_of_course' => [2,3,4,5,6,7,8,9,10]
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .diy-ldactivity ul.slick-dots li:not(.slick-active) button' => 'background-color: {{VALUE}};',
				],
				'condition' => [
					'switch_dots' => 'yes',
					'no_of_course' => [2,3,4,5,6,7,8,9,10]
		...
		$this->add_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .diy-ldactivity ul.slick-dots button' => 'width: {{SIZE}}{{UNIT}};',
				),
				'condition' => [
					'switch_dots' => 'yes',
					'no_of_course' => [2,3,4,5,6,7,8,9,10]
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .diy-la-activity-btn a.diy-la-activity-btn__link' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .diy-la-activity-btn a.diy-la-activity-btn__link' => 'background-color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .diy-la-activity-btn a.diy-la-activity-btn__link' => 'border-color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .diy-la-activity-btn a.diy-la-activity-btn__link:hover' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .diy-la-activity-btn a.diy-la-activity-btn__link:hover' => 'background-color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .diy-la-activity-btn a.diy-la-activity-btn__link:hover' => 'border-color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'label'    => __( 'Typography', 'buddyboss-theme' ),
				'selector' => '{{WRAPPER}} .diy-la-activity-btn a.diy-la-activity-btn__link',
			)
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .diy-la-activity-btn a.diy-la-activity-btn__link' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .diy-la-activity-btn' => 'top: -{{SIZE}}px;',
				],
			]
		);
	...
	protected function render() {
		...
		<div dir="ltr" class="diy-ldactivity <?php echo ( $settings['switch_my_courses'] ) ? 'diy-ldactivity--ismy' : ''; ?>">
		...
		if( is_plugin_active( 'sfwd-lms/sfwd_lms.php' ) ) {
			...
			<?php if ( $no_of_course && is_user_logged_in() ) { ?>
				...
				<?php if ( $settings['switch_my_courses'] ) { ?>
					<div class="diy-la-activity-btn <?php echo ( $no_of_course > 1 ) ? 'diy-la-activity-btn--isslick' : ''; ?>">
						<a class="diy-la-activity-btn__link" href="<?php echo get_site_url(); ?>/courses/?current_page=1&search=&type=my-courses"><?php echo $settings['my_courses_button_text']; ?><i class="bb-icon-angle-right"></i></a>
					</div>
				<?php } ?>
			...
			if ( $no_of_course && is_user_logged_in() && $get_courses_activity ) { ?>
				...
				<div class="diy-la diy-la-composer <?php echo ( $settings['switch_overlap'] && ( $get_courses_activity_num > 1 ) ) ? 'diy-la__overlap' : 'diy-la__plain'; ?> <?php echo ( $no_of_course > 1 ) ? 'diy-la--isslick' : ''; ?>" data-dots="<?php echo ( $settings['switch_dots'] ) ? 'true' : 'false'; ?>">
				...
				<?php foreach ( $get_courses_activity as $course ) {
					...
					<div class="diy-la-slide">
						<div class="diy-la-block flex">

							<?php if ($settings['switch_media']) : ?>	
								<?php if ($settings['switch_progress']) : ?>
									<div class="diy-la__progress <?php echo ($settings['switch_tooltip']) ? 'diy-la__tooltip' : 'diy-la__notooltip'; ?>">
								...
								<?php endif; ?>
								<div class="diy-la__media">
									<div class="diy-la__thumb">
										<div class="thumbnail-container"><img src="<?php echo $course_image; ?>" /></div>
									</div>
								</div>
							<?php endif; ?>
							<div class="diy-la__body">
								<?php if ($settings['switch_course']) : ?>
									<div class="diy-la__parent"><?php echo $course_title; ?></div>
								<?php endif; ?>
								<div class="diy-la__title"><h2><?php echo $last_activity_title; ?></h2></div>
								<?php if ($settings['switch_excerpt']) : ?>
									<div class="diy-la__excerpt"><?php echo $last_activity_excerpt; ?></div>
								<?php endif; ?>
								<?php if ($settings['switch_link']) : ?>
								<div class="diy-la__link"><a href="<?php echo $last_activity_continue; ?>"><?php echo $settings['button_text']; ?></a></div>
								<?php endif; ?>
							</div>
			...
			<?php } else { ?>
				...
				<div class="diy-ldactivity__blank">
					<div class="diy-no-data diy-no-data--ld-activity">
						<img class="diy-no-data__image" src="<?php echo get_template_directory_uri(); ?>/assets/images/svg/dfy-no-data-icon04.svg" alt="Learndash Activity" />
						<?php if ( is_user_logged_in() ) { ?>
							<div class="diy-no-data__msg"><?php _e( 'You don\'t have any ongoing courses.', 'buddyboss-theme' ); ?></div>
						<?php } else { ?>
							<div class="diy-no-data__msg"><?php _e( 'You are not logged in.', 'buddyboss-theme' ); ?></div>
						<?php } ?>
						<a href="<?php echo esc_url( get_post_type_archive_link('sfwd-courses' ) ); ?>" class="diy-no-data__link"><?php _e( 'Explore Courses', 'buddyboss-theme' ); ?></a>
					</div>
				</div>
