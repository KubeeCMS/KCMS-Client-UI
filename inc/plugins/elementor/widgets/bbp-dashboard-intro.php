	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .diy-dash__avatar' => 'flex: 0 0 {{SIZE}}px;',
					'{{WRAPPER}} .diy-dash__avatar img' => 'max-width: {{SIZE}}px; width: {{SIZE}}px;',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'placeholder' => '1px',
				'default'     => '1px',
				'selector'    => '{{WRAPPER}} .diy-dash__avatar img',
				'separator'   => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .diy-dash__avatar img' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .diy-dash__avatar img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .diy-dash__avatar'  => 'margin-right: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '#122B46',
				'selectors' => [
					'{{WRAPPER}} .diy-dash__prior' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '#4D5C6D',
				'selectors' => [
					'{{WRAPPER}} .diy-dash__brief' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .diy-dash__prior .diy-dash__intro',
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .diy-dash__prior .diy-dash__name',
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .diy-dash__brief',
			)
		);
	...
	protected function render() {
		...
		<div class="diy-dash">
			...
			<div class="flex align-items-center">
				<div class="diy-dash__avatar"><?php echo get_avatar( get_current_user_id() ); ?></div>
				<div class="diy-dash__intro">
					<h2 class="diy-dash__prior">
						<span class="diy-dash__intro"><?php echo $settings['heading']; ?></span>
						<span class="diy-dash__name"><?php echo $display_name; ?></span>
					</h2>
					<div class="diy-dash__brief"><?php echo $settings['description']; ?></div>
				</div>
			</div>
